                            ...
                            <div class="card-body">
                                ...
                                >
                                    ...
                                    <template v-slot:cell(actions)="row">
                                        <b-button size="sm" @click="redirectInfo(row.item.id_guru)" class="mx-1 btn-table btn btn-sm btn-info" style="border: none;">Info</b-button>
                                        <b-button size="sm" @click="restore(row.item.id_guru)" class="mx-1 btn-table btn btn-sm btn-warning" style="border: none;">Restore</b-button>
                                        <b-button size="sm" @click="forceDelete(row.item.id_guru)" class="mx-1 btn-table btn btn-sm btn-danger" style="border: none;">Force Delete</b-button>
...
import Info from '../../components/guru/Info'
import MultiInfo from '../../components/guru/MultiInfo'
...
export default {
    data() {
      return {
        ...
        { key: 'nama_guru', label: 'Class name', sortable: true},
    ...
    methods:{
        ...
        async redirectInfo(id){
            try{
                await this.$store.dispatch('guru/GET_INFO_BY_ID', id)
        ...
        async restore(id){
            try{
                await this.$store.dispatch('guru/RESTORE_ONE', id)
        ...
        async forceDelete(id){
            try{
                await this.$store.dispatch('guru/FORCEDELETE_ONE', id)
        ...
        async redirectMultiInfo(){
            try{
                await this.$store.commit('guru/SET_MULTI_INFO', this.selected)
        ...
        async multiRestore(){
            try{
                await this.$store.dispatch('guru/RESTORE_MULTI', this.selected)
        ...
        async multiForceDelete(){
            try{
                await this.$store.dispatch('guru/FORCEDELETE_MULTI', this.selected)
    ...
    async created(){
        await this.$store.dispatch('guru/GET_ALL_TRASH')
    }
}
</script>