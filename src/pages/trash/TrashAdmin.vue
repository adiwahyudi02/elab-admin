                            ...
                            <div class="card-body">
                                ...
                                >
                                    ...
                                    <template v-slot:cell(actions)="row">
                                        <b-button size="sm" @click="redirectInfo(row.item.id)" class="mx-1 btn-table btn btn-sm btn-info" style="border: none;">Info</b-button>
                                        <b-button size="sm" @click="restore(row.item.id)" class="mx-1 btn-table btn btn-sm btn-warning" style="border: none;">Restore</b-button>
                                        <b-button size="sm" @click="forceDelete(row.item.id)" class="mx-1 btn-table btn btn-sm btn-danger" style="border: none;">Force Delete</b-button>
...
import MultiInfo from '../../components/admin/MultiInfo'
...
export default {
    ...
    methods:{
        ...
        async redirectInfo(id){
            try{
                await this.$store.dispatch('admin/GET_INFO_BY_ID', id)
        ...
        async restore(id){
            try{
                await this.$store.dispatch('admin/RESTORE_ONE', id)
        ...
        async forceDelete(id){
            try{
                await this.$store.dispatch('admin/FORCEDELETE_ONE', id)
        ...
        async redirectMultiInfo(){
            try{
                await this.$store.commit('admin/SET_MULTI_INFO', this.selected)
        ...
        async multiRestore(){
            try{
                await this.$store.dispatch('admin/RESTORE_MULTI', this.selected)
        ...
        async multiForceDelete(){
            try{
                await this.$store.dispatch('admin/FORCEDELETE_MULTI', this.selected)
    ...
    async created(){
        await this.$store.dispatch('admin/GET_ALL_TRASH')
    }
}
</script>