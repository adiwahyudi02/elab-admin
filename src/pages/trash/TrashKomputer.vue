                            ...
                            <div class="card-body">
                                ...
                                >
                                    ...
                                    <template v-slot:cell(actions)="row">
                                        <b-button size="sm" @click="redirectInfo(row.item.id_komputer)" class="mx-1 btn-table btn btn-sm btn-info" style="border: none;">Info</b-button>
                                        <b-button size="sm" @click="restore(row.item.id_komputer)" class="mx-1 btn-table btn btn-sm btn-warning" style="border: none;">Restore</b-button>
                                        <b-button size="sm" @click="forceDelete(row.item.id_komputer)" class="mx-1 btn-table btn btn-sm btn-danger" style="border: none;">Force Delete</b-button>
...
export default {
    ...
    methods:{
        ...
        async restore(id){
            try{
                await this.$store.dispatch('komputer/RESTORE_ONE', id)
        ...
        async forceDelete(id){
            try{
                await this.$store.dispatch('komputer/FORCEDELETE_ONE', id)
        ...
        async multiRestore(){
            try{
                await this.$store.dispatch('komputer/RESTORE_MULTI', this.selected)
        ...
        async multiForceDelete(){
            try{
                await this.$store.dispatch('komputer/FORCEDELETE_MULTI', this.selected)
    ...
    async created(){
        await this.$store.dispatch('komputer/GET_ALL_TRASH')
    }
}
</script>