...
class Lab{
    ...
    function create(){
        ...
        // sanitize
        $this->nama_lab=htmlspecialchars(strip_tags($this->nama_lab));
        $this->created_at=htmlspecialchars(strip_tags($this->created_at));
      
        // bind values
        $stmt->bindParam(":nama_lab", $this->nama_lab);
    ...
    function multiDelete(){
        ...
        foreach ($this->selected as $key => $value) {
            $stmt = $this->conn->prepare($query);    
            $this->id_lab=htmlspecialchars(strip_tags($value->id_lab));
            $this->deleted_at=htmlspecialchars(strip_tags($this->deleted_at));
            $stmt->bindParam(":id_lab", $value->id_lab);
            $stmt->bindParam(":deleted_at", $this->deleted_at);
            $stmt->execute();
        }
        return true;
    ...
    function forceDelete(){
        ...
        // delete query
        $query = "DELETE FROM " . $this->table_name . " WHERE id_lab = ?";
  
        // prepare query
        $stmt = $this->conn->prepare($query);
    
        // sanitize
        $this->id=htmlspecialchars(strip_tags($this->id_lab));
    ...
    function multiForceDelete(){
        // query
        $query = "DELETE FROM " . $this->table_name . " WHERE id_lab = :id_lab";
